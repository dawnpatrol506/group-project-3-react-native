...
import Card from '../components/Card.ios';
    ...
    render() {
        return (
            <SafeAreaView style={{ flex: 1, display: 'flex' }}>
                ...
                />
                <ScrollView style={{ backgroundColor: '#039be5' }} refreshControl={<RefreshControl refreshing={this.state.refreshing} onRefresh={this.handleRefresh} />}>
