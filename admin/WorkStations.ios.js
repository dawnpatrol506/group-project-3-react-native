...
import { View, Text, SafeAreaView, ScrollView, Button, RefreshControl, Modal, TextInput, StyleSheet } from 'react-native';
                        ...
                        {this.state.stations ? this.state.stations.map((station, index) => {
                            return (
                                <View key={index} style={styles.row}>
                                    ...
                                    <Button color="#f44336" title='Delete' style={styles.delete} onPress={() => this.handleDelete(station.id)} />
                                </View>
                            )
                        }) : null}
                    </View>
